                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php
                                    $result4->execute(array($rol));
                                     while($row4=$result4->fetch(PDO::FETCH_ASSOC)){
                                    
                                        echo "<tr>";
                                        echo "<td>"; echo $row4['nombre']; echo "</td>";
                                        echo "<td>"; echo $row4['descrip']; echo "</td>";
                                        echo "<td> <div class='alert alert-primary' role='alert'>Tarea Completada</div></td>";
                                        echo "<td><button type='button' class='btn btn-outline-primary'>Ver</button></td>";
                                        echo "</tr>";
                                     }?>
                                     </table>
